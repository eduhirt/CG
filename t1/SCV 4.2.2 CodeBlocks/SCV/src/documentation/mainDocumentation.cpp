...
- g++
- Code::Blocks (Desde a versão 4.2.1)
- VisualC++ 2010
...
Este projeto foi desenvolvido na Universidade Federal de Santa Maria (UFSM), entre 2007 e 2013, pelos seguintes membros:
...
\image html images/LinkerSettings.png

Para rodar os demos ou programas desenvolvidos no CodeBlocks é necessário ter o CodeBlocks instalado.
Existe um projeto standalone ("userProject") para compilação de projetos desenvolvidos pelo usuário, com o uso das ferramentos geradoras de código, InterfaceDesigner e FreeFormInterfaceDesigner).
