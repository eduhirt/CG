...
Application::Application(void) : Kernel() {
   ...
   setWindowTitle("SCV v4.2.2 - Interface Designer");
}
...
void Application::init(void) {
   ...
   _mainPanel->addChild(Singleton<CountersProperties>::getInstance());
   _mainPanel->addChild(Singleton<StringsProperties>::getInstance());
   _mainPanel->addChild(Singleton<StatesProperties>::getInstance());
   _mainPanel->addChild(Singleton<InternalFrameProperties>::getInstance());
   _mainPanel->addChild(Singleton<ImageProperties>::getInstance());
   _mainPanel->addChild(Singleton<FrameProperties>::getInstance());
   ///////////////////////////////////////////////////////////
   ...
   layout->setHorizontalGroup(layout->createParallelGroup()
      ...
      ->addGroup(layout->createParallelGroup()
         ...
         ->addGroup(layout->createParallelGroup(scv::Spring::LEADING, false)
            ...
            ->addComponent(Singleton<CountersProperties>::getInstance())
            ->addComponent(Singleton<StringsProperties>::getInstance())
            ->addComponent(Singleton<StatesProperties>::getInstance())
            ->addComponent(Singleton<InternalFrameProperties>::getInstance())
            ->addComponent(Singleton<ImageProperties>::getInstance())
            ->addComponent(Singleton<FrameProperties>::getInstance())
         )
      )
   );
